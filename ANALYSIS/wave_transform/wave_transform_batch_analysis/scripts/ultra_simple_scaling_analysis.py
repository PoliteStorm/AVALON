 ...
 Methodology Validation:
   ...
   - Complexity Analysis: ✅
    ...
    def process_all_files(self) -> Dict:
        ...
        # Use the correct data paths - 15061491 directory contains the CSV files
        data_dirs = [
            Path("15061491"),  # Main electrical data directory
            Path("csv_data")   # Additional CSV data if available
        ]
        ...
        if not csv_files:
            print(f"❌ No CSV files found in data directories: {[str(d) for d in data_dirs]}")
            return {}
