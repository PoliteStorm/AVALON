#!/usr/bin/env python3
"""
Simple Uniform vs Species-Specific Parameter Comparison
...
def compare_parameter_approaches():
    """Compare uniform vs species-specific parameters using synthetic data."""
    ...
    print("=== TESTING WITH UNIFORM PARAMETERS ===")
    uniform_results = {}
    ...
    if avg_feature_rel_diff > 0.5 or avg_freq_rel_diff > 0.5:
        ...
        print("RECOMMENDATION: Use uniform parameters for unbiased analysis")
        ...
        print("RECOMMENDATION: Consider using uniform parameters for comparison")
    else:
