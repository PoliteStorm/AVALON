#!/usr/bin/env python3
"""
Enhanced Fungal Acoustic Protocol
=================================

🔬 RESEARCH FOUNDATION: Dehshibi & Adamatzky (2021) - Biosystems
DOI: 10.1016/j.biosystems.2021.104373

Enhanced protocol for detecting fungal electrical communication using
research-backed parameters from Pleurotus djamor studies.
